...
Supported bindings and its characteristics are shown [http://msdn.microsoft.com/en-us/library/ms730879(v=vs.110).aspx](here)
...
- Message contracts contains Data like a DatContract, however, it allows to control the structure of SOAP message, e.g. what data should be in header and what in body, or element names. It also makes some restrictions on operation syntax.  [http://msdn.microsoft.com/en-us/library/ms730255(v=vs.110).aspx](MessageContract)
...
img src="../images/choose_binding.jpg"
...
[http://www.codeproject.com/Articles/183708/WCF-Transactions-Brief-Introduction](More)
