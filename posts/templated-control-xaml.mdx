...
```<object id="SilverlightPlugin1" width="800" height="200"
    data="data:application/x-silverlight-2," 
    type="application/x-silverlight-2" >
    <param name="source" value="/data/templated-custom-controls-in-xaml/PacmanSilverlight1.xap"/>
    <!-- Display installation image. -->
    <a href="http://go.microsoft.com/fwlink/?LinkID=149156&v=4.0.60310.0" 
        style="text-decoration: none;">
        <img src="http://go.microsoft.com/fwlink/?LinkId=161376" 
...
```<object id="SilverlightPlugin1" width="800" height="200"
    data="data:application/x-silverlight-2," 
    type="application/x-silverlight-2" >
    <param name="source" value="/data/templated-custom-controls-in-xaml/PacmanSilverlight2.xap"/>
    <!-- Display installation image. -->
    <a href="http://go.microsoft.com/fwlink/?LinkID=149156&v=4.0.60310.0" 
        style="text-decoration: none;">
        <img src="http://go.microsoft.com/fwlink/?LinkId=161376" 
...
<i>**Congratulations:** At this moment we have fully working pacman. And we can change it's size and mouth angle dynamicly.</i>


```<object id="SilverlightPlugin1" width="800" height="200"
    data="data:application/x-silverlight-2," 
    type="application/x-silverlight-2" >
    <param name="source" value="/data/templated-custom-controls-in-xaml/PacmanSilverlight3.xap"/>
    <!-- Display installation image. -->
    <a href="http://go.microsoft.com/fwlink/?LinkID=149156&v=4.0.60310.0" 
        style="text-decoration: none;">
        <img src="http://go.microsoft.com/fwlink/?LinkId=161376" 
...
**After that we can associate visual states with the animations.** About animation and storyboard you can read in my previous post: [Animation in Silverlight 5](/posts/animation-in-xaml/)
...
Source code you can find here [pacman_silverlight](https://Prof-MAG@github.com/Prof-MAG/pacman_silverlight.git)
